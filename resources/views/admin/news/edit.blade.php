                ...
                {{-- <form action="{{ route('events.update')}}" method="POST" enctype="multipart/form-data" name="events" id="events"> --}}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label>Title</label>
                                <input type="text" value="{{$news['title']}}" name="title" placeholder="title" class="form-control"
                                    >
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group ">
                                ...
                                class="form-control">{{$news['about']}}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 m-t-10">
                            <button value="submit"
                                class="btn btn-primary btn-block m-t-5"> <a class="text-white" href="{{ route('newspage.index') }}">Cancel</a></button>
                        </div>
