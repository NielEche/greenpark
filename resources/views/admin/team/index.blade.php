        ...
        <div class="content ">
                ...
                <div class="card card-transparent">
                    <section style="padding-bottom:0px;">
                        <header class="page-header">
                            <h1 class="page-title" style="font-weight: bold !important;">Directors</h1>
                        ...
                        <div class="pull-right">
                            <div class="col-xs-12">
                                <button data-toggle="modal" data-target="#addteam" id="btnStickUpSizeToggler"
                                    class="btn btn-primary btn-cons"><i class="fa fa-plus"></i> Add member 
                                </button>
                            </div>
            ...
            <div class=" container-fluid  container-fixed-lg">
                <div class="row">
                    ...
                    @foreach($attorneys as $index => $team)
                                ...
                                <div class="card-title events">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="{{ asset('uploads/attorneys/') }}/{{ $team->file_path }}"
