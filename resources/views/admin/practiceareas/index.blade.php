    ...
    <div class="page-content-wrapper ">
        <div class="content ">
                ...
                <div class="card card-transparent">
                    <section style="padding-bottom:0px;">
                        <header class="page-header">
                            <h1 class="page-title" style="font-weight: bold !important;">Practice Areas</h1>
                    ...
                    <div class="card-header ">
                        <div class="pull-right">
                            <div class="col-xs-12">
                                <button data-toggle="modal" data-target="#addpractices" id="btnStickUpSizeToggler"
                                    class="btn btn-primary btn-cons"><i class="fa fa-plus"></i> Add Practice Area
                                </button>
                            </div>
            ...
            <div class=" container-fluid  container-fixed-lg">
                <div class="row">
                    @if ($practice->count() > 0)
                    @foreach($practice as $index => $practice)
                                ...
                                <div class="card-title events">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="{{ asset('uploads/practiceAreas/') }}/{{ $practice->file_path }}"
                                ...
                                <div style="display: flex;">
                                    <div class="dropdown dropdown-default">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href={{"editp/".$practice['id']}}>
                                                <button name="edit_event_btn"
                                                    class="btn btn-success"> EDIT <i class="fa fa-pencil"></i></button>
                                            </a>
                                            <a class="dropdown-item" href={{"deleteP/".$practice['id']}}>
...
@include('admin.partials.modals.addpractices')
@endsection
