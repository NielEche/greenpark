<div class="header ">
    ...
    <div class="">
        <div class="brand inline">
            <img src="{{ asset('files/img/content/greenpark.svg') }}"
                data-src-retina="{{ asset('files/img/content/greenpark.svg') }}"
                data-src="{{ asset('files/img/content/greenpark.svg') }}" alt="logo" width="50" height="50">
        </div>
        <ul
        ...
        <div class="dropdown pull-right d-lg-block d-none">
            <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true"
                ...
                <span class="thumbnail-wrapper d32 circular inline">
                    <img src="{{ asset('files/img/content/greenpark.svg') }}" alt="">
                </span>
            </button>
            ...
            <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
                    ...
                    @csrf
                    <x-jet-dropdown-link class="btn btn-danger clearfix bg-master-lighter dropdown-item text-white" href="{{ route('logout') }}" onclick="event.preventDefault();
...
<nav class="page-sidebar" data-pages="sidebar">
    ...
    <div class="sidebar-header">
        <a href="{{ route('liquidbox.index') }}"><img src="{{ asset('files/img/content/greenpark.svg') }}" alt="logo"
                class="brand" data-src="{{ asset('files/img/content/greenpark.svg') }}"
                data-src-retina="{{ asset('files/img/content/greenpark.svg') }}" style="width: 50px; height: 50px"></a>
    </div>
        ...
        <ul class="menu-items">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li class="">
                        <a href="{{ route('attorneys.index') }}" style="color: #fff !important; font-weight: bold !important;">Team Page</a>
                   ...
                   <!-- <li class="">
                    ...
                    <li class="">
                        <a href="{{ route('practiceareas.index') }} " style="color: #fff !important; font-weight: bold !important;">About
                        </a>
                        <span class="icon-thumbnail">AP</span>
                    </li>-->
                    <!--<li class="">
                    ...
                    <li class="">
                        <a href="{{ route('newspage.index') }} " style="color: #fff !important; font-weight: bold !important;">News Page
                        </a>
                        <span class="icon-thumbnail">NP</span>
                    </li>
                    <li class="">
                        <a href="{{ route('appointment.index') }} " style="color: #fff !important; font-weight: bold !important;">Contact Page
                        </a>
