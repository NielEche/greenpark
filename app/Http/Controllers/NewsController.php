...
class NewsController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect('newspage')->with('message', 'News Added Succesfully!');
    ...
    {
        $news = News::find($id);
        return view('pages.newsDetails', ['news'=>$news]); 
    }
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            return redirect('newspage')->with('message', 'News Updated  Succesfully!');
    ...
    public function destroy($id)
    {
        ...
        return redirect('newspage')->with('message','News deleted successfully');
